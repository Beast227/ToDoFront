        ...
        {filteredTodos.length === 0 ? (
          ...
          filteredTodos.map((todo) => (
            <div
              ...
              className={`group flex items-center p-4 bg-gray-900/50 border border-gray-800/50 hover:border-gray-700 rounded-lg cursor-pointer transition-all duration-200 ${
            ...
            >
              ...
              <div className={`shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors ${
                todo.completed ? "bg-cyan-600 border-cyan-600" : "border-gray-600 group-hover:border-cyan-500"
              }`}>
                {todo.completed && (
              ...
              {/* Task Text */}
              <span className={`ml-4 text-sm sm:text-base transition-all ${
